=== Plugin Name ===
Contributors: Mirte
Tags: dashboard, widget, maintenance mode, maintenance, mode
Tested up to: 3.4.1
...
If, for example, your clients want to be able to "turn off" their website for a while, so they can work on new content or features of their website, but you don't want them rummaging through the Wordpress Settings pages to do so, this plugin might be something for you.
